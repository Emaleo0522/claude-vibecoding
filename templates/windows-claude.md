...
4. En PowerShell: `setx CLOUDFLARE_ACCOUNT_ID "..."` y `setx CLOUDFLARE_AI_TOKEN "..."` (ver `.env.example` en raiz del repo)
5. Cerrar y reabrir Claude Desktop para que tome las vars nuevas
